/*
* Integer World Demo Scene with Direct Draw Output (no dependency on GFX library).
...
//IntegerWorld::Adafruit::St7789::DirectDrawSurface Driver(SpiInstance, TFT_CS, TFT_DC, TFT_RST, 21); // https://github.com/adafruit/Adafruit-ST7735-Library
...
IntegerWorld::MockOutput::OutputSurface<256, 256> Driver{}; // Mock output.
